...
int selfcheck(void);
int doit(struct flashctx *flash, int force, const char *filename, const char *backup_filename, int read_it, int write_it, int erase_it, int verify_it, int backup_it);
